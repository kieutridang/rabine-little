...
const FormattedInput = styled(Cleave)`
  ${input}
...
export const FormattedDollarInput = (props) => (
  <FormattedInput
    options={{
      numeral: true,
      prefix: '$',
...
export const FormattedPercentageInput = (props) => (
  <FormattedInput
    options={{
      numeral: true,
      prefix: '%',
...
export const RequiredCharacter = styled.span`
    width: 100%;
    font-size: 12px;
    font-weight: normal;
    font-style: normal;
