...
export default defineMessages({
  ...
  s3FolderLabel: {
    id: 'boilerplate.containers.AddSitePage.s3Folder.label',
    defaultMessage: 'S3 Folder',
  },
  ...
  editDetailButton: {
    id: 'boilerplate.containers.EditDetail.edit.button',
    defaultMessage: 'Edit Site',
  },
  validationMessage_Address_Required: {
    id: 'boilerplate.containers.AddSitePage.validation.address.required',
