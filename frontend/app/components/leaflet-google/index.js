...
// <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD87n8n4JOtijIIgBDsmyeS94F4nBEGQpg&libraries=places"></script>
...
L.GridLayer.GoogleMutant = L.GridLayer.extend({
  ...
  _update: function() {
    ...
    if (zoom !== undefined) {
      this._mutant.setZoom(Math.round(zoom));
    }
  },
